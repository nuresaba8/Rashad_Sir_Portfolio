    ...
    <div class="container mx-auto px-4">
        ...
        <div class="sticky top-0 bg-slate-900 z-50 py-4 mb-6">
            <div class="flex justify-between items-center py-0">
                <h2 class="flex items-center gap-3 text-2xl font-extrabold bg-gradient-to-r from-pink-500 to-cyan-400 text-transparent bg-clip-text">Create Contribution</h2>
        ...
        <div class="bg-slate-800 p-6 rounded-lg shadow-lg max-w-2xl mx-auto">
            ...
            <form action="{{ route('contributionToBasis.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
