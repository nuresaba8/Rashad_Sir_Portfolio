    ...
    <div class="container mx-auto px-4">
        ...
        <div class="sticky top-0 bg-slate-900 z-50 py-4 mb-6">
            <div class="flex justify-between items-center py-0">
                <h2 class="flex items-center gap-3 text-2xl font-extrabold bg-gradient-to-r from-pink-500 to-cyan-400 text-transparent bg-clip-text">Create Article</h2>
        ...
        <div class="bg-slate-800 p-6 rounded-lg shadow-lg max-w-2xl mx-auto">
            ...
            <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label for="article_url" class="block text-white font-medium mb-1">Article Link (optional)</label>
                    <input type="url" id="article_url" name="article_url" class="w-full px-4 py-2 rounded bg-slate-700 text-white focus:outline-none focus:ring focus:ring-indigo-500" value="{{ old('link') }}">
                </div>
